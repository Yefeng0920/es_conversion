...
For this type of data, t and df can be calculated from raw data. Then your can use the two quantities to calculate pcc, correct and wrong SE(pcc) as you like.
...
#readRDS(here("data/converted","dat_r_lnRR_list.RDS"))
